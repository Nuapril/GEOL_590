...
p3<-p2+ annotate("segment", x=c(1,1,5), xend=c(1,5,5), y=c(2.25,2.5,2.5), yend = c(2.5,2.5,2.25)) # adds lines in three segments above samples
...
p4 + ggtitle("Motility, 48 hrs") + theme(plot.title = element_text(hjust = 0.5)) + ylab("cm") + xlab("Mutant")
